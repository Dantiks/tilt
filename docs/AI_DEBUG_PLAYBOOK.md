...
```bash
ssh root@YOUR_SERVER_IP 'journalctl -u tiltab-backend.service --since "7 days ago" --no-pager -o cat' > logs_7d.jsonl
```
...
curl -s http://YOUR_SERVER_IP:3000/health/providers
```
