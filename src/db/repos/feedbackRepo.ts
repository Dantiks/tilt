...
export type FeedbackSource = "telegram" | "web" | "whatsapp";
  ...
  return queryOne<FeedbackEntry>(
    `INSERT INTO feedback
       (request_number, source, rating, category, comment,
        telegram_chat_id, telegram_username, telegram_name, whatsapp_wa_id, web_client_id, job_id,
