...
const TRANSLATIONS: Record<string, Partial<Record<SupportedLanguage, string>>> = {
  ...
  sendYoutubeLink: {
    ky: "TikTok же Instagram Reels шилтемесин жибериңиз:",
    tg: "Пайванди TikTok ё Instagram Reels-ро фиристед:",
    uz: "TikTok yoki Instagram Reels havolasini yuboring:",
    en: "Send me a TikTok or Instagram Reels link:",
    ru: "Отправьте ссылку на TikTok или Instagram Reels:",
  },
  transcribing: {
    ky: "⏳ Распознаоо жатат...",
  ...
  invalidMedia: {
    ky: "Бул шилтемени колдойбойбуз. Азыр TikTok жана Instagram Reels гана иштейт.",
    tg: "Мо ин пайвандро дастгирӣ намекунем. Ҳоло танҳо TikTok ва Instagram Reels кор мекунад.",
    uz: "Biz bu havolani qo'llab-quvvatlamaymiz. Hozircha faqat TikTok va Instagram Reels ishlaydi.",
    en: "We don't support this link. Currently only TikTok and Instagram Reels work.",
    ru: "Мы не поддерживаем эту ссылку. Сейчас работают только TikTok и Instagram Reels.",
  },
  settingsMenu: {
